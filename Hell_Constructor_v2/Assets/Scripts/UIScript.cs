...
public class UIScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            case 0: tutorialText.text = @"Use mouse to look around
use wasd to move";
                break;
            case 1: tutorialText.text = "use shift to sprint";
                break;
            case 2: tutorialText.text = "use space to jump";
                break;
            default: tutorialText.gameObject.SetActive(false);
                break;
        }
